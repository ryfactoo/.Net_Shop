    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleCartItemViewModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleCartItemViewModel_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleCartItemViewModel_CategoryId",
                table: "ArticleCartItemViewModel",
                column: "CategoryId");
